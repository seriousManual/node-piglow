...
PiGlow.prototype.update = function (piGlowConfiguration, callback) {
    ...
    var mappedValues = ledMapper.mapAll(piGlowConfiguration);

    mappedValues = mappedValues.map(gammaCorrection);

    seq()
        .seq(function () {
            that._wire.writeBytes(CMD_SET_PWM_VALUES, mappedValues, this);
        })
        .seq(function () {
