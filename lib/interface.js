...
function create(backend, predefined) {
    ...
    function _writePredefinds(piGlow, predefined) {
        predefined = _normalizePredefined(predefined);

        var keys = Object.keys(predefined);
    ...
    function _normalizePredefined(predefined) {
        if (Array.isArray(predefined)) {
            predefined = predefined.reduce(function (memo, key) {
                memo[key] = processValue.MAX_VALUE;
    ...
    Object.defineProperties(piGlow, {
        ...
        "l_0_0": {
            set: function (v) {
                this.values.l_0_0 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_0 = processValue.MAX_VALUE;
            }
        },
        "l_0_1": {
            set: function (v) {
                this.values.l_0_1 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_1 = processValue.MAX_VALUE;
            }
        },
        "l_0_2": {
            set: function (v) {
                this.values.l_0_2 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_2 = processValue.MAX_VALUE;
            }
        },
        "l_0_3": {
            set: function (v) {
                this.values.l_0_3 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_3 = processValue.MAX_VALUE;
            }
        },
        "l_0_4": {
            set: function (v) {
                this.values.l_0_4 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_4 = processValue.MAX_VALUE;
            }
        },
        "l_0_5": {
            set: function (v) {
                this.values.l_0_5 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_0_5 = processValue.MAX_VALUE;
            }
        },
        "l_1_0": {
            set: function (v) {
                this.values.l_1_0 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_0 = processValue.MAX_VALUE;
            }
        },
        "l_1_1": {
            set: function (v) {
                this.values.l_1_1 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_1 = processValue.MAX_VALUE;
            }
        },
        "l_1_2": {
            set: function (v) {
                this.values.l_1_2 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_2 = processValue.MAX_VALUE;
            }
        },
        "l_1_3": {
            set: function (v) {
                this.values.l_1_3 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_3 = processValue.MAX_VALUE;
            }
        },
        "l_1_4": {
            set: function (v) {
                this.values.l_1_4 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_4 = processValue.MAX_VALUE;
            }
        },
        "l_1_5": {
            set: function (v) {
                this.values.l_1_5 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_1_5 = processValue.MAX_VALUE;
            }
        },
        "l_2_0": {
            set: function (v) {
                this.values.l_2_0 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_0 = processValue.MAX_VALUE;
            }
        },
        "l_2_1": {
            set: function (v) {
                this.values.l_2_1 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_1 = processValue.MAX_VALUE;
            }
        },
        "l_2_2": {
            set: function (v) {
                this.values.l_2_2 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_2 = processValue.MAX_VALUE;
            }
        },
        "l_2_3": {
            set: function (v) {
                this.values.l_2_3 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_3 = processValue.MAX_VALUE;
            }
        },
        "l_2_4": {
            set: function (v) {
                this.values.l_2_4 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_4 = processValue.MAX_VALUE;
            }
        },
        "l_2_5": {
            set: function (v) {
                this.values.l_2_5 = processValue(v);
                this.update();
            },
            get: function () {
                this.l_2_5 = processValue.MAX_VALUE;
            }
        },
        ...
        "leg_0": {
            ...
            get: function () {
                this.leg_0 = processValue.MAX_VALUE;
            }
        },
        "leg_1": {
            set: function (v) {
            ...
            get: function () {
                this.leg_1 = processValue.MAX_VALUE;
            }
        },
        "leg_2": {
            set: function (v) {
            ...
            get: function () {
                this.leg_2 = processValue.MAX_VALUE;
            }
        },
        ...
        "ring_0": {
            ...
            get: function () {
                this.ring_0 = processValue.MAX_VALUE;
            }
        },
        "red": {
            set: function (v) {
        ...
        "ring_1": {
            ...
            get: function () {
                this.ring_1 = processValue.MAX_VALUE;
            }
        },
        "orange": {
            set: function (v) {
        ...
        "ring_2": {
            ...
            get: function () {
                this.ring_2 = processValue.MAX_VALUE;
            }
        },
        "yellow": {
            set: function (v) {
        ...
        "ring_3": {
            ...
            get: function () {
                this.ring_3 = processValue.MAX_VALUE;
            }
        },
        "green": {
            set: function (v) {
        ...
        "ring_4": {
            ...
            get: function () {
                this.ring_4 = processValue.MAX_VALUE;
            }
        },
        "blue": {
            set: function (v) {
        ...
        "ring_5": {
            ...
            get: function () {
                this.ring_5 = processValue.MAX_VALUE;
            }
        },
        "white": {
            set: function (v) {
        ...
        "all": {
            ...
            get: function () {
                this.all = processValue.MAX_VALUE;
            }
        },
