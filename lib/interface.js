...
function create(client) {
    ...
    Object.defineProperties(piGlow, {
        ...
        "l_0_0": {
            set: function (v) { this.values[0] = clamp(v); this.update(); },
            get: function() { this.l_0_0 = 255; }
        },
        "l_0_1": {
            set: function (v) { this.values[1] = clamp(v); this.update(); },
            get: function() { this.l_0_1 = 255; }
        },
        "l_0_2": {
            set: function (v) { this.values[2] = clamp(v); this.update(); },
            get: function() { this.l_0_2 = 255; }
        },
        "l_0_3": {
            set: function (v) { this.values[3] = clamp(v); this.update(); },
            get: function() { this.l_0_3 = 255; }
        },
        "l_0_4": {
            set: function (v) { this.values[14] = clamp(v); this.update(); },
            get: function() { this.l_0_4 = 255; }
        },
        "l_0_5": {
            set: function (v) { this.values[12] = clamp(v); this.update(); },
            get: function() { this.l_0_5 = 255; }
        },
        "l_1_0": {
            set: function (v) { this.values[6] = clamp(v); this.update(); },
            get: function() { this.l_1_0 = 255; }
        },
        "l_1_1": {
            set: function (v) { this.values[7] = clamp(v); this.update(); },
            get: function() { this.l_1_1 = 255; }
        },
        "l_1_2": {
            set: function (v) { this.values[8] = clamp(v); this.update(); },
            get: function() { this.l_1_2 = 255; }
        },
        "l_1_3": {
            set: function (v) { this.values[5] = clamp(v); this.update(); },
            get: function() { this.l_1_3 = 255; }
        },
        "l_1_4": {
            set: function (v) { this.values[4] = clamp(v); this.update(); },
            get: function() { this.l_1_4 = 255; }
        },
        "l_1_5": {
            set: function (v) { this.values[9] = clamp(v); this.update(); },
            get: function() { this.l_1_5 = 255; }
        },
        "l_2_0": {
            set: function (v) { this.values[17] = clamp(v); this.update(); },
            get: function() { this.l_2_0 = 255; }
        },
        "l_2_1": {
            set: function (v) { this.values[16] = clamp(v); this.update(); },
            get: function() { this.l_2_1 = 255; }
        },
        "l_2_2": {
            set: function (v) { this.values[15] = clamp(v); this.update(); },
            get: function() { this.l_2_2 = 255; }
        },
        "l_2_3": {
            set: function (v) { this.values[13] = clamp(v); this.update(); },
            get: function() { this.l_2_3 = 255; }
        },
        "l_2_4": {
            set: function (v) { this.values[11] = clamp(v); this.update(); },
            get: function() { this.l_2_4 = 255; }
        },
        "l_2_5": {
            set: function (v) { this.values[10] = clamp(v); this.update(); },
